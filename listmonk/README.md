Listmonk customizations for Wir machen Wien.
...
- `uploads/assets/images/`: Newsletter and branding image assets.
...
Asset note: templates reference public Listmonk upload URLs under `https://newsletter.wirmachen.wien/uploads/assets/`.
